...
$query="INSERT INTO `members`(`username`, `password`, `Email`) VALUES ('$name','$pass','$email')";
    ...
    <body>
        <div class="main_container">
            ...
            <body style="background-color:black ;">
                ...
                <div class="middelmenu">
                    <div class="slider-container">
                        <div class="slider-wrapper">
                            <div class="slide">
                                <img src="./image/6.jpg" alt="Slide 1" />
                            </div>
                            <div class="slide">
                                <img src="./image/5.jpg" alt="Slide 2" />
                            </div>
                            <div class="slide">
                                <img src="./image/8.webp" alt="Slide 3" />
                            </div>
                        </div>
                        <!-- Navigation buttons -->
                ...
                <div class="endmenu">
                    <text id="t">
                        <P><span style="color: rgb(255, 0, 0);font-weight: bold;">100+ Colleges</span> Here , Find Your
                            Best College<br>Login For More</P>
                    </text>
